class Solution:
    def transpose(self, matrix: list[list[int]]) -> list[list[int]]:
        ...
        # len(matrix) stands for the number of rows in the matrix
        #  This is because the matrix is a list of lists, where each inner list represents a row.

        # len(matrix[0]) stands for the number of columns in the matrix
