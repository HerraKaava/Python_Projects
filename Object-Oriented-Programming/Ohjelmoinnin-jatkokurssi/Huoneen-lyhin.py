...
class Huone:
    ...
    def on_tyhja(self):
        # "if not" checks if the list is empty or not.
        # If the list is empty, the statement evaluates to True --> enter the block and return True.
    ...
    def lyhin(self):
        ...
        if not self.henkilot:
            ...
            # Jos henkilot-lista ei ole tyhjä, palautetaan lyhin henkilö.
    ...
    def poista_lyhin(self):
        ...
        # Huomaa, että pop() -metodi palauttaa listasta poistettavan alkion ja muokkaa listaa ns. "inplace".
...
if __name__ == "__main__":
    ...
    print()    # Tyhjä väli konsolin tulostukseen

    print("Huone tyhjä?", huone.on_tyhja())    # False
    print("Lyhin:", huone.lyhin())    # Nina
